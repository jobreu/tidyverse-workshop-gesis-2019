...
# OR: as csv for a cleaner version
# gapminder_ggplot_input <- 
...
5. maybe have different colors for continents,

6. and choose a proper to `geom` to plot everything.
...
```{block, box.title = "7 (optional)", box.body = list(fill = "white"), box.icon = "fa-star"}
...
```{r load_gapminder_again_solution_log, solution=TRUE}
library(gapminder)
