...
Why would data be non-tidy?  
For example: focus was on data collection and ease of import instead of on data analysis.  
...
---
<h2> Alternative world: Your turn! Excercises :) </h2>
...
Problems
   ...
   * (the data set is in wide-format).
