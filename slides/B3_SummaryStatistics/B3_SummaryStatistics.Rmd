...
If we look at raw numbers, we might have a tough time understanding them.
...
So instead of their monotonous repetition let's see corresponding code from the `tidyverse`.


---
# Used data

Our data are from gapminder, and the focal variable is income per person (fixed 2000 US$) among 275 countries for the years 1960-2011:
...
<span class="footnote">
  Note: `change` is the change of income in percent to the previous year.
</span>
...
---
# Are the points only identical across the datasets?
