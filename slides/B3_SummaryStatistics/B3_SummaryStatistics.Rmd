...
With  the outcommented code above we could use 'group_by' to just see the year in which each country's GDP increased the strongest. Even if we do not care about (other) summary statistics at all.
...
Task: How could you compute mean GDP of 1960-1970 over all countries?
