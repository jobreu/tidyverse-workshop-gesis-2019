...
With the `grouo_by()` function from the `dplyr` package we can perform operations 'by group'. This is especially helpful if you want to compute separate summary statistics with `summarize()` for different groups in your dataset.
