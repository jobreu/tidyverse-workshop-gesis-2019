...
`tidyverse` provides a nice function to create summary statistics called `summarize()`.

--

It's a vecorized tool to create statistics on variables in the non-standard evaluation format for all standard R functions, such as:
