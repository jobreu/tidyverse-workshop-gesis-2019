...
- previously worked in the area of data ingest and curator of the data repository datorium and two DFG research projects on geospatial data data

- other research interests:
    - quantitative methods
    - social inequalities & attitudes towards minorities research
...
- The following packages: `tidyverse`, `gapminder`, `sf` 
]  
...
```{r, eval = F, echo = T}
install.packages(c("tidyverse", "gapminder", "sf"))
```
