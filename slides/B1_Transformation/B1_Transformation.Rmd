...
.bottom[
Please note, that it is a deliberate choice of tibbles to not show 'insignificant' values behind the decimal point. https://github.com/r-lib/pillar/issues/40.
]
...
offset_example <- tibble(
  hour = 8:17,
  productivity = c(80, 90, 120, 120, 50, 
                   50, 70, 100, 110, 70)) # 100 is 'normal'/default
```
...
offset_example %>%
  mutate(
    ranks = min_rank(productivity),
    ranks_rev = min_rank(desc(productivity))
  )
```
